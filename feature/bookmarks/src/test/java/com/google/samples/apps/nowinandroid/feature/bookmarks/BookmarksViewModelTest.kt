...
import com.google.samples.apps.nowinandroid.core.testing.data.createNewsResourcesTestData
...
class BookmarksViewModelTest {
    ...
    private val newsResourceTestData: List<NewsResource> = createNewsResourcesTestData()
    ...
    fun oneBookmark_showsInFeed() = runTest {
        ...
        newsRepository.sendNewsResources(newsResourceTestData)
        userDataRepository.updateNewsResourceBookmark(newsResourceTestData[0].id, true)
    ...
    fun oneBookmark_whenRemoving_removesFromFeed() = runTest {
        ...
        viewModel.removeFromSavedResources(newsResourceTestData[0].id)
